    ...
    <footer className="pt-24 pb-32 border-t border-white/10 bg-[#030303] relative z-10 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="glass-card rounded-3xl p-8 md:p-12 mb-20 flex flex-col md:flex-row items-center justify-between gap-8 border border-white/10 relative overflow-hidden group">
          ...
          <a href="#program" className="shrink-0 relative z-10 w-full md:w-auto">
            <Button size="lg" className="w-full md:w-auto whitespace-nowrap group/btn">
        ...
        {/* Bottom Bar */}
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500 gap-4 text-center md:text-left">
